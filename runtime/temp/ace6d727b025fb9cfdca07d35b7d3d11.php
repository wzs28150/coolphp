...
<!--======= SUB BANNER =========-->
<section class="sub-bnr parallax-bg" data-stellar-background-ratio="0.5" style="background:url(__HOME__/images/slide-4.jpg) no-repeat;">
    <div class="container">
            ...
            <div class="clients-img">
                <ul class="row">
                    <?php $result = db("ad")->where("type_id = 10")->limit(999)->order("")->select();foreach ($result as $i=>$list):if($i > 5): if($list['url'] == '#.'): ?>
                        <li style="margin-top:30px;"><a href="javascript:void(0);"> <img src="__PUBLIC__<?php echo $list['pic']; ?>" class="img-responsive" alt=""> </a></li>
                        <?php else: ?>
                        <li style="margin-top:30px;"><a href="<?php echo $list['url']; ?>" target="_blank"> <img src="__PUBLIC__<?php echo $list['pic']; ?>" class="img-responsive" alt=""> </a></li>
                        <?php endif; else: if($list['url'] == '#.'): ?>
                        <li><a href="javascript:void(0);"> <img src="__PUBLIC__<?php echo $list['pic']; ?>" class="img-responsive" alt=""> </a></li>
                        <?php else: ?>
                        <li><a href="<?php echo $list['url']; ?>" target="_blank"> <img src="__PUBLIC__<?php echo $list['pic']; ?>" class="img-responsive" alt=""> </a></li>
