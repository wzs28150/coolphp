<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"D:\web\3study\CLTP/app/home\view\index_index.html";i:1507857158;s:49:"D:\web\3study\CLTP/app/home\view\common_head.html";i:1507885290;s:56:"D:\web\3study\CLTP/app/home\view\common_photography.html";i:1506478986;s:51:"D:\web\3study\CLTP/app/home\view\common_footer.html";i:1507819406;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div id="content">
    <!-- Our Story -->
    <section class="story padding-top-150 padding-bottom-150">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <!-- Heading -->
    ...
    <!-- Welcome -->
    <section class="padding-top-150 padding-bottom-100" style=" background: url(__HOME__/images/build-feature1.jpg) repeat-y;">
        <div class="container">
    ...
    <section>
        <div class="container">
            ...
            <!-- Heading -->
            <div class="heading text-center" style="margin-top: 150px;"><span>OUR AMAZING WORKS</span>
                <h4>我们惊人的作品</h4>
                <hr>
                <p>
    ...
    <!-- Key Features -->
    <section class="parallax-bg padding-bottom-150 padding-top-150" style="background:url(__HOME__/images/bg-key-feature.jpg) repeat-y;"
    ...
    <!-- Testimonial -->
    <section class="testimonial padding-top-150 padding-bottom-150" style="background:url(__HOME__/images/testi-bg.jpg) repeat-y; background-size:cover;background-attachment:fixed"
    ...
    <section class="blog light-gray-bg padding-bottom-100 padding-top-100">
        <div class="container">
            ...
            ->select();foreach ($result as $k=>$vo):?>
                <!-- BLOG POST -->
                <div class="col-md-4">
                    <article><img class="img-responsive" src="__PUBLIC__<?php echo $vo['thumb']; ?>" alt="" width="100%">
                        <div class="post-info">
                            <div class="post-in">
                                <div class="extra">
                                ...
                                <a href="<?php echo url('home/'.$vo['catdir'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" class="tittle-post"> <?php echo $vo['title']; ?> </a>
                                <p><?php echo str_cut($vo['content'],120,'...'); ?></p>
                                <a href="<?php echo url('home/'.$vo['catdir'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" class="btn-1">阅读更多<i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </article>
                </div>
    ...
    <!-- Contact Form -->
    <section class="contact-info light-gray-bg padding-top-150 padding-bottom-150" id="contact">
        <div class="container">
