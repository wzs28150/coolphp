    ...
    <section class="blog blog-page blog-col-2 padding-top-150 padding-bottom-150">
        <div class="container">
            <div class="row">
                <div class="col-md-9 padding-right-30">
                    ...
                    <div class="row">
                        ...
                        <!-- BLOG POST -->
                        <div class="col-md-6">
                            <article> <img class="img-responsive" src="<?php echo $vo['title_thumb']; ?>" alt="">
                                <div class="post-info">
                                    <div class="post-in">
                                        <div class="extra"> <span><i class="icon-calendar"></i><?php echo toDate($vo['createtime'],'Y-m-d'); ?></span>
                                            <span
                                                class="margin-left-15"><i class="icon-user"></i><?php echo $vo['zuozhe']; ?></span> <span class="margin-left-15"><i class="icon-bubbles"></i> <?php echo getcatname($vo['catid']); ?></span></div>
                                        <a href="<?php echo url('home/'.$vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" class="tittle-post"><?php echo $vo['title']; ?></a>
                                        <p>
                                            <?php echo cutstr_html($vo['content'],120,'...'); ?>
                                        </p>
                                        <a href="<?php echo url('home/'.$vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" class="btn-1">阅读更多<i class="fa fa-angle-right"></i></a>                                        </div>
                                </div>
                            </article>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            ->select();foreach ($result as $k=>$vo):?>
                        ...
                        <hr class="main">
                        <ul class="cate archive">
                            <li><a href="#."> 5月 2015</a></li>
                            <li><a href="#."> 6月 2015</a></li>
                            <li><a href="#."> 7月 2015</a></li>
                            <li><a href="#."> 8月 2015</a></li>
                            <li><a href="#."> 9月 2015</a></li>
                        </ul>
